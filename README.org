...
A fun indexing project using DocBook 5 to make the Richard Adams' epic lapine novel /Watership Down/ accessible:
...
This might be extended in the future to other fun novels like Frank Herbert's /Dune/ etc.
